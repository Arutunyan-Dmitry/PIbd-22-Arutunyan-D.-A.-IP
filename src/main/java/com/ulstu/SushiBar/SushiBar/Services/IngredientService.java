...
public class IngredientService {
    ...
    @Transactional
    public Ingredient addIngredient(String ingredientName, int grm) {
        final Ingredient ingredient = new Ingredient(ingredientName, grm);
    ...
    @Transactional
    public Ingredient removeIngredientFromDish(Long ingredientId, Long dishId) {
        final Optional<Ingredient> ingredient = IngredientRepository.findById(ingredientId);
        final Optional<Dish> dish = DishRepository.findById(dishId);
        ingredient.orElseThrow(() ->
                        new IngredientNotFoundException(ingredientId))
